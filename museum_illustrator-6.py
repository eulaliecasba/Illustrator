...
MIN_IMG_H = 130         # smallest image we'll place inline before spilling
...
# A gap must hold a decent image plus its citation, else we spill to a page.
MIN_INLINE_GAP = MIN_IMG_H + CAPTION_H + 20  # ~196pt
